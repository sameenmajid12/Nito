  ...
  return (
    <View style={styles.mainContainer}>
      <View style={styles.headerContainer}>
        ...
        <Pressable style={styles.viewAll} onPress={()=>navigate("ConnectionScreen")}><Text style={styles.viewAllText}>View all</Text><Ionicons size={FONT_SIZE_M} color={colors.primaryDark} name="chevron-forward-outline"></Ionicons></Pressable>
      </View>
